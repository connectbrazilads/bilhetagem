      ...
      {health ? (
        <div className="mt-4 grid gap-4 md:grid-cols-4">
          ...
          <HealthStat
            ...
            detail={`${health.agents_offline.toLocaleString("pt-BR")} offline, ${health.pending_queue_actions.toLocaleString("pt-BR")} acao(oes), ${health.stale_queue_actions.toLocaleString("pt-BR")} atrasada(s)`}
          ...
          <HealthStat
            ...
            detail={`${health.usb_queues.toLocaleString("pt-BR")} USB, ${health.duplicate_queue_aliases.toLocaleString("pt-BR")} duplicada(s), ${health.generic_queue_aliases.toLocaleString("pt-BR")} generica(s)`}
            tone={
              health.unbound_queues > 0 || health.duplicate_queue_aliases > 0 || health.generic_queue_aliases > 0
                ? "warn"
                : "ok"
            }
            icon={Activity}
